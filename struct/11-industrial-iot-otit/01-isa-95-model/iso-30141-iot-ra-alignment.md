...
ISO/IEC 30141 是国际标准化组织（ISO）与国际电工委员会（IEC）联合制定的物联网（IoT）参考架构国际标准。该标准的第一版（ISO/IEC 30141:2018）为全球 IoT 系统的概念化和设计提供了首个统一的参考框架。2024 年发布的第二版（ISO/IEC 30141:2024）进行了重大更新，**全面遵循 ISO/IEC/IEEE 42010:2022《系统和软件工程—架构描述》的元模型要求**，在架构描述的一致性、可追溯性和可验证性方面实现了显著提升。
