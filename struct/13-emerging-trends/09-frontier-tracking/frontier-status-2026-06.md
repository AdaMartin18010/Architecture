...
- [Phase D 前沿跟踪文档](#phase-d-前沿跟踪文档)
  ...
  - [4. ISO 新标准发布跟踪](#4-iso-新标准发布跟踪)
    ...
    - [4.4 ISO/IEC 26550:2025](#44-isoiec-265502025)
...
- 本项目已冻结所有 ArchiMate 4.0 相关内容引用
- 当前所有 ArchiMate 相关文档仅引用官方发布的 3.2 版本
- 在 book-outline-v2.md 第 2 章中明确标注引用版本为 ArchiMate 3.2

**待执行行动**:

- 一旦 ArchiMate 4.0 正式发布，需更新以下文档：
  1. `book-outline-v2.md` 第 2 章（架构描述语言与元模型）
  2. `struct/` 目录下所有涉及 ArchiMate 引用的文档
  3. 元模型映射表与概念对照表
...
| 影响维度 | 评估 | 优先级 |
|----------|------|--------|
| **元模型一致性** | ArchiMate 4.0 可能引入新元模型概念，需更新映射表 | 🟡 中 |
| **工具链兼容性** | 主流建模工具（Archi、BiZZdesign）将在 4.0 发布后更新 | 🟢 低 |
| **标准合规性** | 保持引用 3.2 版本可确保当前文档的标准合规性 | ✅ 已处理 |

**建议行动**:

1. 订阅 The Open Group ArchiMate Forum 邮件列表，获取 4.0 发布第一手通知
2. 在文档中保留版本号标注，便于 4.0 发布后批量替换
3. 暂不基于 ArchiMate 4.0 传闻特性做任何架构决策
...
| **Phase A 状态** | AWI（Approved Work Item，已批准工作项目） |
| **当前状态** | 🟡 **仍在制定中** |
| **预期发布** | 2026 年末至 2027 年初 |
| **跟踪说明** | Phase A 已完成 AWI 状态跟踪；目前尚未进入 FDIS（Final Draft International Standard）阶段 |

**权威来源**: <https://www.iso.org/standard/63712.html>
...
**权威来源**: <https://www.iso.org/standard/82606.html>
...
**权威来源**: <https://www.iso.org/standard/64768.html>

**对本项目的影响**: 已在 Phase B 完成引用，当前版本无需更新。

### 4.4 ISO/IEC 26550:2025

| 属性 | 详情 |
|------|------|
| **标准名称** | ISO/IEC 26550:2025 — Software and systems engineering — Methods and tools for model-driven product lines |
| **定位** | 产品线工程方法学与工具 |
| **当前状态** | ✅ **已发布（2025）** |
| **核心内容** | 模型驱动的产品线工程方法、可变性建模、领域工程与应用工程 |

**权威来源**: <https://www.iso.org/standard/85294.html>

**对本项目的影响**: 26550:2025 的产品线工程方法与"大规模软件复用"高度相关，建议在 Phase E 中增加对该标准的引用与映射。

### 4.5 ISO/IEC 5338（AI 系统生命周期）

| 属性 | 详情 |
|------|------|
| **标准名称** | ISO/IEC 5338 — Information technology — Artificial intelligence — AI system life cycle processes |
| **定位** | AI 系统生命周期过程标准 |
| **当前状态** | 🟡 **制定中（WD 或 CD 阶段）** |
| **预期发布** | 2026-2027 |
| **与 12207 关系** | 作为 12207 的 AI 领域专用扩展 |
...
|----------|----------|----------------|----------|--------|
| ISO/IEC 12207:2026 | 软件生命周期过程 | AWI（跟踪中） | 🟡 仍在制定中 | 🔴 高 |
| ISO/IEC AWI 42030 | 架构评估 | — | 🟡 AWI 阶段 | 🟡 中 |
| ISO/IEC 25040:2024 | 质量评估框架 | 已发布（Phase B） | ✅ 已发布 | ✅ 已处理 |
| ISO/IEC 26550:2025 | 产品线工程 | — | ✅ 已发布 | 🟡 中 |
| ISO/IEC 5338 | AI 系统生命周期 | — | 🟡 制定中 | 🟡 中 |
...
| 属性 | 详情 |
|------|------|
| **标准名称** | IEC 62443-4-2:2025 — Security for industrial automation and control systems — Technical security requirements for IACS components |
| **定位** | 工业自动化控制系统组件的技术安全要求 |
| **当前状态** | ✅ **已发布（2025）** |
| **更新要点** | 增强了对嵌入式软件、固件更新机制、供应链安全的具体要求 |
...
| **IEC 62443-4-2** | **组件技术安全要求** | **✅ 已发布（2025）** |
...
| 2026-09 | ISO/IEC JTC 1/SC 7 工作会议（可能更新 12207:2026 进度） | ISO | 🟡 中 |
...
| 日期 | 事件 | 来源 | 优先级 |
|------|------|------|--------|
| 2027-01 | ISO/IEC 12207:2026 可能进入 FDIS 或发布 | ISO | 🔴 高 |
