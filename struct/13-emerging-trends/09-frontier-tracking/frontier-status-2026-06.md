...
- [Phase D 前沿跟踪文档](#phase-d-前沿跟踪文档)
  ...
  - [7. 工业物联网前沿](#7-工业物联网前沿)
    - [7.1 IEC 62443 系列更新](#71-iec-62443-系列更新)
      - [7.1.1 IEC 62443-4-2:2019](#711-iec-62443-4-22025)
      - [7.1.2 系列全貌](#712-系列全貌)
  ...
  - [文档元数据](#文档元数据)
  - [补充说明：Phase D 前沿跟踪文档](#补充说明phase-d-前沿跟踪文档)
  - [概念定义](#概念定义)
  - [示例](#示例)
  - [反例](#反例)
  - [分析](#分析)
...
- ✅ The Open Group 已于 2026-04-27 正式发布 ArchiMate 4.0
...
- **The Open Group ArchiMate 4.0 发布新闻稿**: <https://www.opengroup.org/The-Open-Group-Announces-ArchiMate%C2%AE-4-Specification>
...
> **勘误说明（2026-06-12）**: 此前本项目误将 IEC 62443-4-2:2019 标注为 2025 版。经权威来源复核，IEC 62443-4-2:2019 现行版为 **2019**；2025 年发布的是 **IEC TS 62443-6-2:2025**（评估方法论）。
...
**对本项目的影响**: 工业场景下的软件架构复用必须满足 IEC 62443-4-2:2019 的安全等级要求（SL-1 至 SL-4），建议在工业物联网复用指南中明确引用。
