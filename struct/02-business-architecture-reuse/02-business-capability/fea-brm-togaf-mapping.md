...
联邦企业架构业务参考模型（Federal Enterprise Architecture Business Reference Model, FEA BRM 2.0）由美国白宫 OMB 于 2003 年 6 月发布，是 FEA 五大参考模型（PRM, BRM, SRM, DRM, TRM）的**业务层基石**。其核心设计原则是：**以功能驱动（function-driven）描述联邦政府业务运营，而非以机构组织（agency-oriented）描述**。
