...
> **版本**: 2026-06-08
> **定位**: P4-T6 交付物 — IEEE 1517 复用过程标准与 ISO/IEC 12207:2017、ISO/IEC 26550:2015 及本体系四层复用架构对齐
...
- **与 IEEE 12207 / ISO/IEC 12207:2017 的互补**：12207 定义了通用的系统与软件生命周期过程（技术过程、管理过程、支持过程、组织过程），将复用视为跨过程的横切关注点；而 IEEE 1517 则提供了独立的、专门化的复用过程视图，使组织能够以系统化方式实施复用，而不仅将其作为通用过程的附加注记。
...
## 3. 与 ISO/IEC 12207:2017 的对照映射

ISO/IEC/IEEE 12207:2017 将复用 concern 整合为跨生命周期的活动，而 IEEE 1517 则将其提升为独立过程组。下表给出核心过程的对照：

| IEEE 1517 过程 | ISO 12207:2017 对应过程 | 差异说明 |
|---------------|------------------------|----------|
...
> **关键版本差异**：12207:2008 曾设有独立的 "Software Reuse Processes" 过程组；12207:2017 将其拆解为横切活动，更强调复用是生命周期各过程的内在属性。IEEE 1517 保留了独立过程视图，为需要系统化复用治理的组织提供了可操作的框架。
...
2. ISO/IEC/IEEE. *ISO/IEC/IEEE 12207:2017 — Systems and software engineering — Software life cycle processes*. 2017. <https://www.iso.org/standard/63712.html>
