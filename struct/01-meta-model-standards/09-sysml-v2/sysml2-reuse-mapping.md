...
| **对齐标准** | OMG SysML v2（2023）、ISO/IEC 42010:2022、OMG RAS 2.0、ISO/IEC 26550:2023、OMG KDM、IEEE 1471 |
| **状态** | ✅ 已完成 |
...
- [OMG SysML v2 与架构复用映射指南](#omg-sysml-v2-与架构复用映射指南)
  ...
  - [6. SysML v2 与产品线工程（ISO 26550）的结合](#6-sysml-v2-与产品线工程iso-26550的结合)
    - [6.1 ISO/IEC 26550:2023 概述](#61-isoiec-265502023-概述)
...
### 6.1 ISO/IEC 26550:2023 概述

ISO/IEC 26550:2023《软件与系统工程 — 产品线工程》定义了产品线工程（Product Line Engineering, PLE）的参考模型，核心概念包括：
...
| [5] | ISO/IEC 26550:2023, Software and Systems Engineering — Product Line Engineering | <https://www.iso.org/standard/81739.html> | 2026-06-10 |
