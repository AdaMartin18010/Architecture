...
[^4]: Hayhurst, K. J., Veerhusen, D. S., Chilenski, J. J., & Rierson, L. K. (2001). A Practical Tutorial on Modified Condition/Decision Coverage. *NASA/TM-2001-210876*. MC/DC 的权威教学文献，含形式化定义和工业应用指南。

[^5]: Chilenski, J. J., & Miller, S. P. (1994). Applicability of Modified Condition/Decision Coverage to Software Testing. *Software Engineering Journal*, 9(5), 193-200. MC/DC 的理论奠基论文。
