...
- `01-meta-model-standards/04-archimate-4/archimate-iso-mapping.md`：ArchiMate 4.0 的关系类型（serving、realization、aggregation）与本规约中的 `MappingType`（Refinement、Realization）语义对应。
