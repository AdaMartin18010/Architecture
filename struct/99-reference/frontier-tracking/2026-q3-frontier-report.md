...
| **IEC 61508 Ed.3** | 工业安全层 | CDV 投票完成（RVC 2026-05-15，65A/1231~1234/RVC）；IEC 官方 Fcst. Publ. Date 2026-07；TÜV 等认证机构自 2026-06 起已可按 61508-3:2026 执行 SIL 2+ 认证 | 预创建 Ed.2→Ed.3 迁移指南 | 🟡 P1 |
...
3. **IEC 61508 Ed.3**：RVC 已于 2026-05-15 发布（65A/1231~1234/RVC），关注 IEC 官方预测 2026-07 的正式出版及 TÜV 等认证机构按 61508-3:2026 执行的落地节奏。
