...
- **等价/映射概念**：ISO/IEC/ISO/IEC/IEEE 42020:2019（架构治理）、ISO/IEC 12207（软件生命周期过程治理）；
...
- [B-04 ISO 25040:2024 复用评估流程映射](#b-04-iso-250402024-复用评估流程映射)
  ...
  - [5. 与 ISO/IEC/ISO/IEC/IEEE 42030:2019 架构评估框架的协同](#5-与-isoiecieee-42030-架构评估框架的协同)
    - [5.1 ISO/IEC/ISO/IEC/IEEE 42030:2019 概述](#51-isoiecieee-42030-概述)
...
ISO/IEC/ISO/IEC/IEEE 42030:2019 推荐的方法之一是 ATAM（Architecture Tradeoff Analysis Method）。在复用场景中，ATAM 可调整为以下流程：
