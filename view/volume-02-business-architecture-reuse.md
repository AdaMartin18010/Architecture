...
1. [01 业务域复用（Business Domain Reuse）](02-business-architecture-reuse/01-business-domain-reuse/README.md)
2. [业务能力复用](02-business-architecture-reuse/02-business-capability/capability-reuse.md)
3. [FEA BRM 2.0 与 TOGAF 10 Phase B 业务能力图交叉映射](02-business-architecture-reuse/02-business-capability/fea-brm-togaf-mapping.md)
4. [价值流复用的形式化组合](02-business-architecture-reuse/03-value-stream/value-stream-composition.md)
5. [04 业务流程复用（Business Process Reuse）](02-business-architecture-reuse/04-business-process-reuse/README.md)
6. [05 业务服务复用（Business Service Reuse）](02-business-architecture-reuse/05-business-service-reuse/README.md)
7. [BPMN 2.0 / DMN 1.5 可执行语义案例集](02-business-architecture-reuse/06-bpmn-dmn/bpmn-dmn-executable-cases.md)
8. [BPMN 2.0 / DMN 业务过程与决策的复用编排](02-business-architecture-reuse/06-bpmn-dmn/bpmn-dmn-reuse-orchestration.md)
9. [DoDAF / UAF 1.3 / NAF 4.0 与软件架构复用视角映射](02-business-architecture-reuse/07-defense-mission-engineering/dodaf-uaf-reuse.md)
10. [NAF 4.0 / MODAF 与北约架构复用视角映射](02-business-architecture-reuse/07-defense-mission-engineering/naf-modaf-reuse.md)
11. [Zachman Framework 与软件架构复用映射文档](02-business-architecture-reuse/08-zachman-reuse-mapping/zachman-reusability-matrix.md)
12. [BIAN 金融服务域复用案例](02-business-architecture-reuse/case-studies/bian-banking-reuse-case.md)
13. [行业垂直场景案例库](02-business-architecture-reuse/case-studies/industry-vertical-cases.md)
14. [C-06 TMForum ODF / eTOM 电信架构复用](02-business-architecture-reuse/case-studies/tmforum-telecom-reuse.md)
15. [02 业务架构复用](02-business-architecture-reuse/README.md)
...
- [FEA BRM 2.0 与 TOGAF 10 Phase B 业务能力图交叉映射](02-business-architecture-reuse/02-business-capability/fea-brm-togaf-mapping.md) — 业务能力与标准框架的详细映射
- [价值流复用的形式化组合](02-business-architecture-reuse/03-value-stream/value-stream-composition.md) — 能力如何组合为价值流
- [Zachman Framework 与软件架构复用映射](02-business-architecture-reuse/08-zachman-reuse-mapping/zachman-reusability-matrix.md) — 能力在 Zachman 矩阵中的位置
- [BIAN 金融服务域复用案例](02-business-architecture-reuse/case-studies/bian-banking-reuse-case.md) — 银行业能力复用实践
...
### 7.1 概念补充：业务能力作为战略-IT 对齐锚点

**定义**：业务能力复用不仅是对稳定能力单元的共享，更是将企业战略意图通过能力层面向 IT 实现传递的治理机制。一个可复用的业务能力应当具备清晰的业务成果（Outcome）、稳定的边界、可度量的 KPI，以及独立于组织结构和实现技术的接口契约。

### 7.2 业务能力-流程-服务映射矩阵

业务能力、业务流程与业务服务是业务架构复用中的三大核心概念，三者形成“能力 → 流程 → 服务”的层次映射。
...
该图展示了业务能力复用的典型模式：**高稳定性能力通过标准化业务服务暴露，再由不同业务流程调用**。例如“验证客户身份”能力同时支撑登录验证和开户 KYC 两个流程。

### 7.4 正例补充：跨渠道客户身份验证能力复用
...
- **与价值流的关系**：价值流是业务能力按端到端价值目标的有序组合。能力复用是价值流复用的前提。
- **与 [BPMN](https://en.wikipedia.org/wiki/Business_process_modeling) 的关系**：业务流程是能力的执行视图，BPMN 是流程复用的主要载体。
- **与 [Zachman Framework](https://en.wikipedia.org/wiki/Zachman_Framework) 的关系**：业务能力主要映射到 Zachman 的 C2-1（What, Business）和 C2-2（How, Business）。
...
>
> - [Zachman Framework - Wikipedia](https://en.wikipedia.org/wiki/Zachman_Framework) — 企业架构分类框架
> - [Business process modeling - Wikipedia](https://en.wikipedia.org/wiki/Business_process_modeling) — 业务流程建模与能力的关系
> - [The Open Group TOGAF Standard, 10th Edition](https://www.opengroup.org/togaf) — TOGAF 业务能力定义
> - [FEA BRM 2.0](https://www.whitehouse.gov/omb/management/federal-enterprise-architecture/) — 联邦企业架构业务参考模型
>
> **核查日期**: 2026-07-07
...
- [Zachman Framework 与软件架构复用映射](02-business-architecture-reuse/08-zachman-reuse-mapping/zachman-reusability-matrix.md)
...
- [业务能力复用](02-business-architecture-reuse/02-business-capability/capability-reuse.md) — 价值流组合的能力单元
- [BPMN 2.0 / DMN 业务过程与决策的复用编排](02-business-architecture-reuse/06-bpmn-dmn/bpmn-dmn-reuse-orchestration.md) — 价值流的可执行编排
- [Zachman Framework 与软件架构复用映射](02-business-architecture-reuse/08-zachman-reuse-mapping/zachman-reusability-matrix.md) — 价值流在 Zachman Why/What/How 维度的映射
- [BIAN 金融服务域复用案例](02-business-architecture-reuse/case-studies/bian-banking-reuse-case.md) — 金融服务价值流复用
...
### 8.1 价值流与业务能力/业务流程的映射矩阵

[Value stream](https://en.wikipedia.org/wiki/Value_stream) 是端到端价值创造的序列，其价值流组合（Value Stream Composition）需要在业务能力、业务流程与业务服务之间建立清晰的映射关系。
...
### 8.2 价值流组合模式补充：循环反馈与事件驱动

除了线性、并行、条件分支和可插拔阶段外，价值流还经常需要 **循环反馈** 和 **事件驱动** 两种模式。

**循环反馈模式**：价值流的最后一个阶段将反馈信息传递回早期阶段，形成持续改进闭环。例如“产品交付”阶段收集客户反馈，触发“需求识别”阶段的优化。
...
**事件驱动模式**：价值流的推进不由预设顺序决定，而由业务事件触发。例如“库存低于阈值”事件触发“补货价值流”，“客户投诉”事件触发“客诉处理价值流”。

### 8.3 正例补充：制造业订单到交付价值流复用

**背景**：某制造业集团在亚太、欧洲、北美拥有多个工厂，各工厂独立设计“订单到交付（Order-to-Delivery, OTD）”流程，导致：

- 同一客户在不同区域下单，交付体验不一致。
- 供应链协同成本高，库存积压与缺货并存。
- 新产品导入时，每个工厂都需要重新设计 OTD 流程。
...
- [BPMN 2.0 / DMN 1.5 可执行语义案例集](02-business-architecture-reuse/06-bpmn-dmn/bpmn-dmn-executable-cases.md) — 具体可执行案例
- [BIAN 金融服务域复用案例](02-business-architecture-reuse/case-studies/bian-banking-reuse-case.md) — BPMN/DMN 在金融场景的结合
- [业务能力复用](02-business-architecture-reuse/02-business-capability/capability-reuse.md) — 业务复用层定义
- [价值流复用的形式化组合](02-business-architecture-reuse/03-value-stream/value-stream-composition.md) — 端到端价值流与 BPMN 编排的关系
...
- [BPMN 2.0 / DMN 1.5 可执行语义案例集](02-business-architecture-reuse/06-bpmn-dmn/bpmn-dmn-executable-cases.md) — 更多可执行示例
- [业务能力复用](02-business-architecture-reuse/02-business-capability/capability-reuse.md) — 业务能力复用的定义与属性
- [价值流复用的形式化组合](02-business-architecture-reuse/03-value-stream/value-stream-composition.md) — BPMN 流程与价值流的关系
...
> **对齐标准**: DoDAF 2.02 / UAF 1.3 / NAF 4.0 / ISO 42010:2022
> **状态**: ✅ 已完成
> **字数**: ~4000 字
...
- [DoDAF / UAF 1.3 / NAF 4.0 与软件架构复用视角映射](#dodaf--uaf-13--naf-40-与软件架构复用视角映射)
  ...
  - [6. 与 ISO 42010:2022 的对照](#6-与-iso-420102022-的对照)
    - [6.1 ISO 42010:2022 核心概念](#61-iso-420102022-核心概念)
    - [6.2 DoDAF 到 ISO 42010:2022 的映射](#62-dodaf-到-iso-420102022-的映射)
    - [6.3 UAF 到 ISO 42010:2022 的映射](#63-uaf-到-iso-420102022-的映射)
    - [6.4 NAF 4.0 到 ISO 42010:2022 的映射](#64-naf-40-到-iso-420102022-的映射)
...
将 DoDAF/UAF/NAF 映射至 ISO 42010:2022，有助于理解国防架构框架在通用架构理论中的定位，并促进国防架构与民用架构的互理解。
...
UAF 1.3 在设计上更贴近 ISO 42010:2022 的现代概念体系：
...
NAF 4.0 在元模型设计中直接参考了 ISO 42010:2022 的术语体系，其映射最为直接：

- **NAF 视点（Viewpoint）** = ISO 42010 视点
- **NAF 视图（View）** = ISO 42010 视图
- **NAF 元模型（Meta-Model）** = ISO 42010 模型种类规范 + 对应关系规范
- **NAF 架构描述（Architecture Description）** = ISO 42010 架构描述

### 6.5 综合对照意义

通过 ISO 42010:2022 的中立框架，可以实现以下跨框架复用目标：

1. **元模型桥接**: 使用 ISO 42010 的对应关系机制，建立 DoDAF 元素与 UAF 元素、NAF 元素之间的形式化映射；
2. **工具互操作**: 任何符合 ISO 42010 的架构工具均可通过适配层导入/导出 DoDAF/UAF/NAF 模型；
3. **培训与知识转移**: 以 ISO 42010 为共同语言，降低不同框架背景架构师之间的沟通成本；
4. **复用资产标准化**: 将国防架构复用资产（如能力本体、服务契约、接口规范）封装为符合 ISO 42010 的通用架构描述组件，实现跨领域复用。
...
视图层的设计遵循 ISO 42010:2022 的架构描述标准，每个视图由以下要素构成：
...
- 本主题内：[BIAN 金融服务域复用案例](02-business-architecture-reuse/case-studies/bian-banking-reuse-case.md) — 银行业的 Zachman 复用坐标实践
- 本主题内：[BPMN 2.0 / DMN 业务过程与决策的复用编排](02-business-architecture-reuse/06-bpmn-dmn/bpmn-dmn-reuse-orchestration.md) — 填充 Zachman How/Why 维度的可执行标准
- 本主题内：[业务能力复用](02-business-architecture-reuse/02-business-capability/capability-reuse.md) — 业务复用层核心资产定义
- 上层标准：[FEA BRM 2.0 与 TOGAF 10 Phase B 业务能力图交叉映射](02-business-architecture-reuse/02-business-capability/fea-brm-togaf-mapping.md) — 业务能力框架映射
...
BIAN 服务域是银行业务能力的标准化表达，可映射到通用业务能力模型。参见 [业务能力复用](02-business-architecture-reuse/02-business-capability/capability-reuse.md)。

### 10.2 与 TOGAF/FEA 的关系

BIAN 提供银行业特定的 ABB（架构构建块），TOGAF 提供 ABB 的管理方法论，FEA BRM 提供跨行业业务能力分类参考。详细映射见 [FEA BRM 2.0 与 TOGAF 10 Phase B 业务能力图交叉映射](02-business-architecture-reuse/02-business-capability/fea-brm-togaf-mapping.md)。
...
BIAN 服务域可映射到 Zachman 矩阵的 C2-1（What, Business）、C2-2（How, Business）和 C3-2（How, System）等 cell。参见 [Zachman Framework 与软件架构复用映射](02-business-architecture-reuse/08-zachman-reuse-mapping/zachman-reusability-matrix.md)。
...
- [Zachman Framework 与软件架构复用映射](02-business-architecture-reuse/08-zachman-reuse-mapping/zachman-reusability-matrix.md) — BIAN 服务域在 Zachman 矩阵中的坐标
- [BPMN 2.0 / DMN 业务过程与决策的复用编排](02-business-architecture-reuse/06-bpmn-dmn/bpmn-dmn-reuse-orchestration.md) — BIAN 与 BPMN/DMN 的结合
- [业务能力复用](02-business-architecture-reuse/02-business-capability/capability-reuse.md) — 服务域作为银行业务能力单元
- [价值流复用的形式化组合](02-business-architecture-reuse/03-value-stream/value-stream-composition.md) — 金融服务价值流组合
- [FEA BRM 2.0 与 TOGAF 10 Phase B 业务能力图交叉映射](02-business-architecture-reuse/02-business-capability/fea-brm-togaf-mapping.md) — BIAN 与 FEA/TOGAF 的映射基础
...
- [业务能力复用](02-business-architecture-reuse/02-business-capability/capability-reuse.md) — BIAN 服务域作为银行业务能力单元
- [价值流复用的形式化组合](02-business-architecture-reuse/03-value-stream/value-stream-composition.md) — 金融服务价值流组合
- [BPMN 2.0 / DMN 业务过程与决策的复用编排](02-business-architecture-reuse/06-bpmn-dmn/bpmn-dmn-reuse-orchestration.md) — BIAN 与 BPMN/DMN 的结合
- [Zachman Framework 与软件架构复用映射](02-business-architecture-reuse/08-zachman-reuse-mapping/zachman-reusability-matrix.md)
