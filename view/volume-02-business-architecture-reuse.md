...
- [统一复用决策模型](../struct/06-cross-layer-governance/06-up-downgrade-matrix/unified-reuse-decision-model.md) — DMN 决策表在统一决策栈中定位为 L4 执行编码层
...
> - [ISO/IEC/IEEE 42010:2022](https://www.iso.org/standard/74393.html) — 系统与软件工程架构描述
...
电信行业架构师在实际工作中，常常需要将 TMForum 标准与企业架构框架（如 TOGAF Standard 10）和行业特定标准（如 BIAN）进行对照和映射。
...
![02 业务架构复用 — 知识体系思维导图](../struct/99-reference/visualizations/mindmaps/02-business-architecture-reuse.svg)

![02 业务架构复用 — 复用层次决策树](../struct/99-reference/visualizations/decision-trees/02-business-architecture-reuse-decision-tree.svg)
