...
6.3 A2A v1.0 协议架构：Agent Card → Task → Artifact → Message → Part
...
12.2 A2A v1.0 复用流程：Agent Card → 任务委托 → 消息交互 → 结果交付 → 安全验证
...
> v2.0 扩展覆盖：ISO/IEC/IEEE 42010:2022/42020/42030 族、TOGAF Standard 10、ArchiMate 3.2、ISO/IEC 26550:2015/26566、BPMN 2.0/DMN 1.5、SLSA 1.0、SPDX/CycloneDX、IEC 61508/62443/63278、ISA-95、OPC UA FX、MCP 2025-11-25、A2A v1.0、Conformal Prediction、WASI 0.3、**DoDAF 2.02 / UAF 1.2 / NAF v4**、**Zachman Framework**、**GERAM / ISO 15704:2019**、**ISO/IEC 33000 (SPICE)**、**ISO/IEC 25040:2024**、**BIAN 7.0**、**DORA 2025**、**OpenSSF Scorecard**、**ISO/IEC 30141:2024**、**Green Software Patterns / SCI**
...
2. **行业框架与协议**：The Open Group TOGAF Standard 10 / ArchiMate 3.2、**DoDAF 2.02 / UAF 1.2 / NAF v4**、**Zachman Framework**、**GERAM / ISO 15704:2019**、**BIAN 7.0**、OpenSSF SLSA 1.2、**OpenSSF Scorecard**、MCP 2025-11-25、Google A2A v1.0
...
2. **行业框架与协议**：The Open Group TOGAF Standard 10 / ArchiMate 3.2、OpenSSF SLSA 1.2、MCP 2025-11-25、Google A2A v1.0
...
>
> 依据: MCP 2025-11-25, A2A v1.0, ISO/IEC/IEEE 42010:2022 Correspondence Rule
...
>
> 依据: MCP 2025-11-25, A2A v1.0 Specification
