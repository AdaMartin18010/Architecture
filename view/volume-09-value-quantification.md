...
- [价值量化碳维度扩展：SCI 复用碳模型](#价值量化碳维度扩展sci-复用碳模型)
  ...
  - [7. 正向示例](#7-正向示例)
    - [示例 1：Rust 数据解析库复用](#示例-1rust-数据解析库复用)
    - [示例 2：AI 预训练模型复用](#示例-2ai-预训练模型复用)
  - [8. 反例](#8-反例)
    - [反例 1：绿色清洗式复用](#反例-1绿色清洗式复用)
    - [反例 2：忽视隐含碳 M](#反例-2忽视隐含碳-m)
    - [反例 3：用碳抵消降低 SCI](#反例-3用碳抵消降低-sci)
  - [9. 交叉引用](#9-交叉引用)
  - [10. 分析与决策建议](#10-分析与决策建议)
    - [10.1 复用碳决策流程](#101-复用碳决策流程)
    - [10.2 关键结论](#102-关键结论)
  - [11. 权威来源](#11-权威来源)
