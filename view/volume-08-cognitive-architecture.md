...
9. [08 认知架构与复用决策](../struct/08-cognitive-architecture/README.md)
...
> **对齐**: ISO/IEC 26566:2026（产品线纹理 product line texture 方法/工具能力）、ACT-R (CMU)、NASA-TLX、RAG 最佳实践
> **状态**: 草案，待 PoC 验证
...
- Sweller, J. (1988). Cognitive Load Theory. *Learning and Instruction*.
- 交叉引用: [`08/03-cognitive-load-theory/quantitative-model.md`](../struct/08-cognitive-architecture/03-cognitive-load-theory/quantitative-model.md)
