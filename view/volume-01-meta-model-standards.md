...
1. [核心标准对齐矩阵](01-meta-model-standards/01-iso-420xx-family/alignment-matrix.md)
2. [ISO/IEC/IEEE AWI 42030 修订跟踪](01-meta-model-standards/01-iso-420xx-family/awi-42030-tracking.md)
3. [IEEE 1517-2010 软件生命周期复用过程](01-meta-model-standards/01-iso-420xx-family/ieee-1517-reuse-processes.md)
4. [ISO/IEC/IEEE 12207:2026 与软件复用过程对齐](01-meta-model-standards/01-iso-420xx-family/iso-12207-2026-alignment.md)
5. [ISO/IEC 25010:2023 AI/ML 质量特性与复用评估](01-meta-model-standards/01-iso-420xx-family/iso-25010-2023-ai-quality.md)
6. [ISO/IEC 25010:2023 产品质量模型更新](01-meta-model-standards/01-iso-420xx-family/iso-25010-2023-update.md)
7. [ISO/IEC/IEEE 42010:2022 关键更新（第二版）](01-meta-model-standards/01-iso-420xx-family/iso-42010-2022-update.md)
8. [ISO/IEC/IEEE 42010:2022 与架构复用](01-meta-model-standards/01-iso-420xx-family/iso-42010-2022.md)
9. [ISO/IEC/IEEE DIS 42024 + DIS 42042 权威对齐（2025‑2026，2026-06-12 更新 ArchiMate 4.0 状态）](01-meta-model-standards/01-iso-420xx-family/iso-42024-42042-dis-alignment.md)
10. [TOGAF 10 ABB/SBB 与 ISO 42010:2022 的详细映射](01-meta-model-standards/02-togaf-10-alignment/detailed-mapping.md)
11. [TOGAF 10 企业连续体与构建块复用](01-meta-model-standards/02-togaf-10-alignment/togaf-enterprise-continuum-reuse.md)
12. [ISO 26550:2015 产品线工程参考模型与 ISO 42010/42020 的交叉映射](01-meta-model-standards/03-iso-26550-ple/ple-iso-integration.md)
13. [ArchiMate 3.2 元素与 ISO 42010:2022 的对照表（含 4.0 预览标注）](01-meta-model-standards/04-archimate-4/archimate-iso-mapping.md)
14. [SWEBOK V4 知识领域与软件工程架构复用知识体系对应关系](01-meta-model-standards/05-swebok-v4/swebok-alignment.md)
15. [公理-定理体系严格性审计报告](01-meta-model-standards/06-formal-axioms/axiom-rigor-audit.md)
16. [形式化公理体系](01-meta-model-standards/06-formal-axioms/axiom-system.md)
17. [公理体系的批判与边界](01-meta-model-standards/06-formal-axioms/critique-and-boundaries.md)
18. [公理-定理依赖关系图](01-meta-model-standards/06-formal-axioms/dependency-graph.md)
19. [四层架构复用概念本体（CARC）](01-meta-model-standards/06-formal-axioms/four-layer-ontology.md)
20. [定理推导集](01-meta-model-standards/06-formal-axioms/theorem-derivations.md)
21. [OMG RAS v2.2 与四层复用架构对齐](01-meta-model-standards/07-omg-ras/ras-alignment.md)
22. [FAIR4RS 原则与软件复用对照](01-meta-model-standards/08-fair4rs/fair4rs-alignment.md)
23. [OMG SysML v2 与架构复用映射指南](01-meta-model-standards/09-sysml-v2/sysml2-reuse-mapping.md)
24. [MBSE 模型复用与产品线工程整合指南](01-meta-model-standards/10-mbse-reuse/mbse-ple-integration.md)
25. [01 元模型与标准对齐](01-meta-model-standards/README.md)
...
- **依赖概念**：矩阵依赖 [`iso-42010-2022.md`](01-meta-model-standards/01-iso-420xx-family/iso-42010-2022.md) 的术语定义、[`../02-togaf-10-alignment/detailed-mapping.md`](01-meta-model-standards/02-togaf-10-alignment/detailed-mapping.md) 的方法论映射，以及 [`../04-archimate-4/archimate-iso-mapping.md`](01-meta-model-standards/04-archimate-4/archimate-iso-mapping.md) 的语言映射。
...
- ISO 42010 核心概念详见 [`iso-42010-2022.md`](01-meta-model-standards/01-iso-420xx-family/iso-42010-2022.md)
- TOGAF 企业连续体与构建块复用详见 [`../02-togaf-10-alignment/togaf-enterprise-continuum-reuse.md`](01-meta-model-standards/02-togaf-10-alignment/togaf-enterprise-continuum-reuse.md)
- ArchiMate 与 ISO 42010 映射详见 [`../04-archimate-4/archimate-iso-mapping.md`](01-meta-model-standards/04-archimate-4/archimate-iso-mapping.md)
- SWEBOK V4 对齐详见 [`../05-swebok-v4/swebok-alignment.md`](01-meta-model-standards/05-swebok-v4/swebok-alignment.md)
- 四层复用本体详见 [`../06-formal-axioms/four-layer-ontology.md`](01-meta-model-standards/06-formal-axioms/four-layer-ontology.md)
...
- 同步更新 [`ras-alignment.md`](01-meta-model-standards/07-omg-ras/ras-alignment.md) 中的 SLSA 字段扩展表。
...
- 矩阵中涉及的所有核心概念详见 [`iso-42010-2022.md`](01-meta-model-standards/01-iso-420xx-family/iso-42010-2022.md)
- TOGAF 企业连续体与构建块复用详见 [`../02-togaf-10-alignment/togaf-enterprise-continuum-reuse.md`](01-meta-model-standards/02-togaf-10-alignment/togaf-enterprise-continuum-reuse.md)
- ArchiMate 与 ISO 42010 映射详见 [`../04-archimate-4/archimate-iso-mapping.md`](01-meta-model-standards/04-archimate-4/archimate-iso-mapping.md)
- RAS 可复用资产规范对齐详见 [`../07-omg-ras/ras-alignment.md`](01-meta-model-standards/07-omg-ras/ras-alignment.md)
- FAIR4RS 与软件复用对照详见 [`../08-fair4rs/fair4rs-alignment.md`](01-meta-model-standards/08-fair4rs/fair4rs-alignment.md)
...
> **版本**: 2026-06-08
> **定位**: P4-T6 交付物 — IEEE 1517 复用过程标准与 ISO/IEC/IEEE 12207（当前版 :2026，历史映射基于 :2017）、ISO/IEC 26550:2015 及本体系四层复用架构对齐
> **对齐来源**: IEEE Std 1517-2010; ISO/IEC/IEEE 12207:2026（现行） / 12207:2017（历史对照）; ISO/IEC 26550:2015; TOGAF 10
> **状态**: Phase 2（2026-Q4）
> **权威链接**:
>
...
**IEEE Std 1517-2010** — *Information Technology — System and Software Life Cycle Processes — Reuse Processes* 是 IEEE 专门针对系统与软件生命周期中复用活动的标准规范。它并非孤立存在，而是在 IEEE 标准体系中与多个核心标准形成互补关系：

- **与 IEEE 12207 / ISO/IEC/IEEE 12207:2026 的互补**：12207 定义了通用的系统与软件生命周期过程（技术过程、管理过程、支持过程、组织过程），将复用视为跨过程的横切关注点；而 IEEE 1517 则提供了独立的、专门化的复用过程视图，使组织能够以系统化方式实施复用，而不仅将其作为通用过程的附加注记。本节映射以 **ISO/IEC/IEEE 12207:2026** 为现行基准；历史对照版（2017）的过程名称和关系保持一致。
- **与 ISO/IEC 42020:2019 的互补**：42020 定义了架构过程框架，1517 的复用活动可映射到 42020 的架构规划、开发、评估与维护活动中（详见 [01/02-togaf-10-alignment/detailed-mapping.md](01-meta-model-standards/02-togaf-10-alignment/detailed-mapping.md)）。

为什么需要专门的复用过程标准？通用生命周期过程（如 12207）假设每个项目从零开始定义需求、设计、实现；而复用驱动的方法论要求**双向过程**：一方面通过领域工程主动生产可复用资产，另一方面通过应用工程按需消费和适配资产。这种"供-需"双轨结构需要超越单一项目边界的治理机制，这正是 IEEE 1517 存在的核心价值。
...
ISO/IEC/IEEE 12207:2026 将复用 concern 整合为跨生命周期的活动，而 IEEE 1517 则将其提升为独立过程组。下表给出核心过程的对照：
...
> **关键版本差异**：12207:2008 曾设有独立的 "Software Reuse Processes" 过程组；12207:2017 / 2026 将其拆解为横切活动，更强调复用是生命周期各过程的内在属性。IEEE 1517 保留了独立过程视图，为需要系统化复用治理的组织提供了可操作的框架。

---

## 4. 与 ISO/IEC 26550:2015 产品线工程的对照

ISO/IEC 26550:2015（Software and Systems Engineering — Reference Model for Product Line Engineering and Management）与 IEEE 1517 在结构上高度同源，但聚焦点不同：
...
本体系采用四层复用架构（业务架构 → 应用架构 → 组件架构 → 功能架构），IEEE 1517 的三过程组与各层的映射关系如下：
...
以下检查清单按 IEEE 1517 三大过程组组织，每组 10 项，共 30 项。每项标注了与 NASA RRL（Reuse Readiness Levels）、RCMM、RiSE-RM 的成熟度等级映射（详见 [06/03-maturity-models/reuse-maturity-models-rcmm-rise.md](06-cross-layer-governance/03-maturity-models/reuse-maturity-models-rcmm-rise.md)）。
...
| AE-02 | 已评估候选资产的适配成本（AAF < 0.7 为绿灯） | RRL 4-5 | L3 已定义 | L3 计划复用 |
...
4. **持续跟踪标准演进**：关注 IEEE 1517 后续修订及 ISO 对应复用标准的发布动态。
...
1. IEEE. *IEEE Std 1517-2010 — Standard for Information Technology — System and Software Life Cycle Processes — Reuse Processes*. 2010. <https://standards.ieee.org/standard/1517-2010.html>
...
> **交叉引用**: [01/02-togaf-10-alignment/detailed-mapping.md](01-meta-model-standards/02-togaf-10-alignment/detailed-mapping.md) · [06/03-maturity-models/reuse-maturity-models-rcmm-rise.md](06-cross-layer-governance/03-maturity-models/reuse-maturity-models-rcmm-rise.md)
> **最后更新**: 2026-06-08
...
**定义**：IEEE 1517-2010 定义了软件生命周期中复用过程的结构，包括组织管理、领域工程、资产提供、资产消费与资产维护等过程。
...
> **定位**: 对齐 ISO 25010:2023 最新版的关键变化（取代 2011 版，新增 AI/ML 质量特性考量）
...
这是 ISO 25010:2023 最重要的新增内容之一，反映了功能安全与 AI/ML 系统质量在软件系统中的重要性。

---

## 4. Quality in Use 模型

2024 版将 Quality in Use（使用质量）从 ISO 25010 移至 **ISO/IEC 25019**。使用质量包括：
...
- ISO 42010 更新跟踪详见 [`iso-42010-2022-update.md`](01-meta-model-standards/01-iso-420xx-family/iso-42010-2022-update.md)
- 标准对齐矩阵详见 [`alignment-matrix.md`](01-meta-model-standards/01-iso-420xx-family/alignment-matrix.md)
- TOGAF 详细映射详见 [`../02-togaf-10-alignment/detailed-mapping.md`](01-meta-model-standards/02-togaf-10-alignment/detailed-mapping.md)
- ArchiMate 映射详见 [`../04-archimate-4/archimate-iso-mapping.md`](01-meta-model-standards/04-archimate-4/archimate-iso-mapping.md)
...
> Wikipedia 概念结构参见 [ISO/IEC/IEEE 42010](https://en.wikipedia.org/wiki/ISO/IEC/IEEE_42010)。
...
> **权威来源**：
>
> - [ISO/IEC/IEEE 42010:2022](https://www.iso.org/standard/74296.html) — ISO 官方页面
> - [ISO/IEC/IEEE 42010 - Wikipedia](https://en.wikipedia.org/wiki/ISO/IEC/IEEE_42010)
> - [IEEE 1471-2000](https://standards.ieee.org/standard/1471-2000.html)
> - [The Open Group - TOGAF](https://www.opengroup.org/togaf)
> - [The Open Group - ArchiMate](https://www.opengroup.org/archimate)
>
...
> **项目建议**：ArchiMate 4 Specification 已于 2026-04-27 正式发布，与 ArchiMate 3.2 向后兼容。新项目中可优先采用 ArchiMate 4.0 以利用 Common Domain 和统一行为元素带来的简化；现有 3.2 模型无需重写即可逐步迁移。
...
- TOGAF 详细映射文档详见 [`detailed-mapping.md`](01-meta-model-standards/02-togaf-10-alignment/detailed-mapping.md)
- ArchiMate 与 ISO 42010 映射详见 [`../04-archimate-4/archimate-iso-mapping.md`](01-meta-model-standards/04-archimate-4/archimate-iso-mapping.md)
- 四层复用本体详见 [`../06-formal-axioms/four-layer-ontology.md`](01-meta-model-standards/06-formal-axioms/four-layer-ontology.md)
- ISO 42010 核心概念详见 [`../01-iso-420xx-family/iso-42010-2022.md`](01-meta-model-standards/01-iso-420xx-family/iso-42010-2022.md)
...
1. 产品线工程的领域工程（Domain Engineering）和应用工程（Application Engineering）如何在 ISO 42010 的架构描述框架中被表达？
2. ISO 42020 的六大架构过程如何支撑产品线工程的双轨生命周期？
...
在此基础上，以下建立与 ISO 42010/42020 的核心概念桥梁：
...
- **ISO/IEC 26550:2015, Clause 4.2** — 定义了产品线参考模型的五个组成部分（策略规划、组织、方法论、系统和组件集成、配置管理）。本映射将这五个组成部分分别映射到 ISO 42010 的架构描述元素和 ISO 42020 的架构过程。[[来源](https://www.iso.org/obp/ui/#iso:std:iso-iec:26550:ed-2:v1:en)]
- **ISO/IEC 26550:2015, Clause 5.3** — 明确了领域工程与应用工程的双轨生命周期，以及可变性在两条轨道之间的传递机制。本映射的第 3、4 节逐层展开了这一双轨机制与 ISO 42010/42020 的对应关系。
- **ISO/IEC 26580:2021** — 作为 ISO 26550 的配套标准，提供了基于特征的产品线工程方法与工具指南，进一步细化了 Feature Model、Variation Point、Binding 等概念的操作定义。[[来源](https://www.iso.org/standard/71883.html)]
...
1. **产品线工程的双轨生命周期与 ISO 42020 的架构过程形成精确对应**：领域工程对应 Conceptualization + Elaboration（概念化与细化），应用工程对应 Evaluation + Enablement（评估与使能），而 Governance + Management（治理与管理）贯穿双轨。
2. **ISO 26550 的 Core Asset / Variability Model 与 ISO 42010 的 View Component / Concern / Model Kind 形成精确对应**：产品线资产是可复用的架构描述组件，可变性是架构关注点的特殊化表达。
3. **产品线工程作为"系统化复用"的最高形式，其元模型基础已被 ISO 42010/42020 完整覆盖**：从战略治理到资产使能，从概念描述到过程执行，标准 trio（26550 + 42010 + 42020）共同构成了可复用架构的工程化基础。
...
5. Pohl, K., Böckle, G., & van der Linden, F. *Software Product Line Engineering: Foundations, Principles and Techniques*. Springer, 2005.（ISO 26550 的核心参考来源之一）
...
- ISO 42010 核心概念详见 [`../01-iso-420xx-family/iso-42010-2022.md`](01-meta-model-standards/01-iso-420xx-family/iso-42010-2022.md)
- 标准对齐矩阵详见 [`../01-iso-420xx-family/alignment-matrix.md`](01-meta-model-standards/01-iso-420xx-family/alignment-matrix.md)
- TOGAF 企业连续体与构建块复用详见 [`../02-togaf-10-alignment/togaf-enterprise-continuum-reuse.md`](01-meta-model-standards/02-togaf-10-alignment/togaf-enterprise-continuum-reuse.md)
- 四层复用本体详见 [`../06-formal-axioms/four-layer-ontology.md`](01-meta-model-standards/06-formal-axioms/four-layer-ontology.md)
- SWEBOK V4 对齐详见 [`../05-swebok-v4/swebok-alignment.md`](01-meta-model-standards/05-swebok-v4/swebok-alignment.md)
...
在当前框架中，M.3 面临三个严格性问题。第一，**论域未封闭**。\mathcal{R}*{L_i} 和 \mathcal{R}*{L_j} 的元素是什么？是架构描述？实现制品？还是抽象概念？若论域不封闭，则「所有函数 f」的量化没有意义。第二，**Reuse(L_i) 的语义不明确**。左侧是一个层次，右侧是一个复用谓词，两者类型不匹配。形式化中应写作 \mathrm{Reuse}(r_i, \mathit{ctx}) 对于 r_i \in \mathcal{R}_{L_i}，而非直接对层次应用复用谓词。第三，**「保持复用语义」未定义**。什么是语义保持？是观察行为等价？是价值流等价？还是约束集同构？在没有精确定义的情况下，无法构造否证或证明。
...
3. **本体论与信息系统理论基础**
   - Bunge, M. (1977). *Treatise on Basic Philosophy: Ontology I: The Furniture of the World*. D. Reidel Publishing.
   ...
   - ISO/IEC 21838-3:2023. *Information technology — Top-level ontologies (TLO) — Part 3: DOLCE*.

4. **组件化软件工程与 Liskov 替换原则**
   - Liskov, B. (1987). Data abstraction and hierarchy. *OOPSLA 1987*.
...
- ArchiMate 与 ISO 42010 映射详见 [`../04-archimate-4/archimate-iso-mapping.md`](01-meta-model-standards/04-archimate-4/archimate-iso-mapping.md)
- SWEBOK V4 对齐详见 [`../05-swebok-v4/swebok-alignment.md`](01-meta-model-standards/05-swebok-v4/swebok-alignment.md)
- OMG RAS 对齐详见 [`../07-omg-ras/ras-alignment.md`](01-meta-model-standards/07-omg-ras/ras-alignment.md)
- FAIR4RS 对齐详见 [`../08-fair4rs/fair4rs-alignment.md`](01-meta-model-standards/08-fair4rs/fair4rs-alignment.md)
...
- [架构-复用二元性公理](01-meta-model-standards/06-formal-axioms/axiom-system.md#m1-architecture-reuse-duality)
- [可变性公理](01-meta-model-standards/06-formal-axioms/axiom-system.md#m2-variability-axiom)
- [层次不可约性公理](01-meta-model-standards/06-formal-axioms/axiom-system.md#m3-hierarchy-non-reduction)
- [同一性保持公理](01-meta-model-standards/06-formal-axioms/axiom-system.md#m4-identity-preservation)
...
> **状态**: ✅ 已完成
> **交叉引用**: [`01-iso-420xx-family/alignment-matrix.md`](01-meta-model-standards/01-iso-420xx-family/alignment-matrix.md)
...
> 详见 [`01-iso-420xx-family/alignment-matrix.md`](01-meta-model-standards/01-iso-420xx-family/alignment-matrix.md) 中的标准族谱与主题-标准对齐矩阵。
...
> **对齐来源**: FAIR4RS Principles v1.0 (RDA, 2022), Chue Hong et al. (2022), ISO/IEC 25010:2023, OMG RAS v2.2, IEEE 1517-2010
> **状态**: ✅ 已完成
> **交叉引用**: [`../07-omg-ras/ras-alignment.md`](01-meta-model-standards/07-omg-ras/ras-alignment.md), [`../01-iso-420xx-family/ieee-1517-reuse-processes.md`](01-meta-model-standards/01-iso-420xx-family/ieee-1517-reuse-processes.md)
...
- **FAIR4RS ↔ ISO/IEC 25010:2023**：Reusable 映射到 ISO 25010 的 Reusability 子特性；Interoperable 映射到 Compatibility；Findable/Accessible 映射到 Portability/Flexibility 的信息可获取性。
- **FAIR4RS ↔ IEEE 1517**：领域工程阶段关注 Findable + Interoperable；应用工程阶段关注 Accessible + Reusable；复用管理阶段关注 Reusable。
- **FAIR4RS ↔ 四层复用架构**：
...
- OMG RAS 对齐详见 [`../07-omg-ras/ras-alignment.md`](01-meta-model-standards/07-omg-ras/ras-alignment.md)
- IEEE 1517 复用过程详见 [`../01-iso-420xx-family/ieee-1517-reuse-processes.md`](01-meta-model-standards/01-iso-420xx-family/ieee-1517-reuse-processes.md)
- ISO 42010 核心概念详见 [`../01-iso-420xx-family/iso-42010-2022.md`](01-meta-model-standards/01-iso-420xx-family/iso-42010-2022.md)
- 四层复用本体详见 [`../06-formal-axioms/four-layer-ontology.md`](01-meta-model-standards/06-formal-axioms/four-layer-ontology.md)
- SWEBOK V4 对齐详见 [`../05-swebok-v4/swebok-alignment.md`](01-meta-model-standards/05-swebok-v4/swebok-alignment.md)
...
- [OMG SysML v2 与架构复用映射指南](#omg-sysml-v2-与架构复用映射指南)
  ...
  - [4. SysML v2 与 ISO/IEC 42010:2022 的对照](#4-sysml-v2-与-isoiec-420102022-的对照)
