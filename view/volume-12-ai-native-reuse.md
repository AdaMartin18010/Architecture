...
1. [MCP 2025-11-25 权威规范解读](12-ai-native-reuse/01-mcp-protocol/mcp-2025-11-25-authoritative.md)
2. [MCP 2025-11-25 综合更新与复用影响评估](12-ai-native-reuse/01-mcp-protocol/mcp-2025-11-25-comprehensive-update.md)
3. [MCP 2025-11-25 规范深度解析](12-ai-native-reuse/01-mcp-protocol/mcp-2025-11-25-deep-dive.md)
4. [MCP 2026-07-28 RC 深度解析](12-ai-native-reuse/01-mcp-protocol/mcp-2026-deep-dive.md)
5. [A2A v1.0.0 协议复用分析](12-ai-native-reuse/02-a2a-protocol/a2a-reuse-analysis.md)
6. [A2A v1.0 权威规范解读](12-ai-native-reuse/02-a2a-protocol/a2a-v1-authoritative.md)
7. [A2A v1.0.0 权威深度解析](12-ai-native-reuse/02-a2a-protocol/a2a-v1-deep-dive.md)
8. [P5-T2：Agentic Governance 组织设计模板](12-ai-native-reuse/03-agentic-infrastructure/agentic-governance-template.md)
9. [LLM Agent 的复用与组合](12-ai-native-reuse/03-agentic-infrastructure/llm-agent-composition.md)
10. [A2A + MCP 混合 Agent 服务 PoC](12-ai-native-reuse/04-hybrid-a2a-mcp-poc/README.md)
11. [概率契约运行时监控指标](12-ai-native-reuse/05-probabilistic-contracts/monitoring-metrics.md)
12. [OWASP LLM / MCP 安全对齐](12-ai-native-reuse/05-probabilistic-contracts/owasp-llm-mcp-security.md)
13. [AI 概率契约（Probabilistic Contract）框架](12-ai-native-reuse/05-probabilistic-contracts/probabilistic-contract-framework.md)
14. [概率契约校准工具 (Probabilistic Contract Calibration)](12-ai-native-reuse/05-probabilistic-contracts/README.md)
15. [AI 功能服务等级协议（SLA）模板](12-ai-native-reuse/05-probabilistic-contracts/templates/ai-sla-template.md)
16. [概率契约校准报告模板](12-ai-native-reuse/05-probabilistic-contracts/templates/calibration-report-template.md)
17. [NIST AI 风险管理框架与架构复用映射](12-ai-native-reuse/06-ai-governance/nist-ai-rmf-reuse-mapping.md)
18. [Conformal Prediction 在代码生成中的统计保证应用](12-ai-native-reuse/07-conformal-prediction/cp-code-generation.md)
19. [CP + 形式化验证融合框架（研究探索方向）](12-ai-native-reuse/07-conformal-prediction/cp-formal-verification.md)
20. [12 AI 原生复用](12-ai-native-reuse/README.md)
...
- 与 A2A 协议的关系见 [`../02-a2a-protocol/a2a-v1-authoritative.md`](12-ai-native-reuse/02-a2a-protocol/a2a-v1-authoritative.md)
- 与概率契约的结合见 [`../05-probabilistic-contracts/probabilistic-contract-framework.md`](12-ai-native-reuse/05-probabilistic-contracts/probabilistic-contract-framework.md)
- 与 OWASP LLM 安全映射见 [`../05-probabilistic-contracts/owasp-llm-mcp-security.md`](12-ai-native-reuse/05-probabilistic-contracts/owasp-llm-mcp-security.md)
- 与 Agent 组合模式见 [`../03-agentic-infrastructure/llm-agent-composition.md`](12-ai-native-reuse/03-agentic-infrastructure/llm-agent-composition.md)
- 与 A2A+MCP 混合 PoC 见 [`../04-hybrid-a2a-mcp-poc/README.md`](12-ai-native-reuse/04-hybrid-a2a-mcp-poc/README.md)
...
> **交叉引用**: 本文档与 [mcp-2025-11-25-deep-dive.md](12-ai-native-reuse/01-mcp-protocol/mcp-2025-11-25-deep-dive.md) 互补，后者侧重规范技术细节，本文档侧重生态演进与复用决策框架
> **权威来源**:
>
...
| **复用影响** | Tasks 使 MCP Server 从"同步函数"升级为"可编排的工作流节点"，支持跨会话的持久化请求跟踪。在复用架构中，这意味着 MCP Server 可以作为长时间运行服务被集成，而非仅限于短时状态less函数调用。详见 [deep-dive §3.1](12-ai-native-reuse/01-mcp-protocol/mcp-2025-11-25-deep-dive.md#31-tasks-能力sep-1686) |
...
> 对比：2026-03 月 SDK 下载量为 9,700 万+（见 [authoritative.md §7](12-ai-native-reuse/01-mcp-protocol/mcp-2025-11-25-authoritative.md#7-mcp-生态系统状态2026-05)），**两个月内增长约 13%**，增速持续。
...
> **最佳实践**: 在多层 Agent 架构中，外层 Agent 间使用 **A2A** 协作，每个 Agent 内部通过 **MCP** 访问工具和数据，底层通过 **直接 API** 连接传统服务。详见 [deep-dive §6](12-ai-native-reuse/01-mcp-protocol/mcp-2025-11-25-deep-dive.md#6-与-a2a-协议的关系)。
...
> **最后更新**: 2026-06-10
> **文档状态**: P5-T1 交付物，与 [mcp-2025-11-25-deep-dive.md](12-ai-native-reuse/01-mcp-protocol/mcp-2025-11-25-deep-dive.md) 和 [mcp-2025-11-25-authoritative.md](12-ai-native-reuse/01-mcp-protocol/mcp-2025-11-25-authoritative.md) 构成 MCP 规范三层文档体系
...
> 请参考最新权威文档：
>
> - [`mcp-2025-11-25-deep-dive.md`](12-ai-native-reuse/01-mcp-protocol/mcp-2025-11-25-deep-dive.md)
> - [`mcp-2025-11-25-authoritative.md`](12-ai-native-reuse/01-mcp-protocol/mcp-2025-11-25-authoritative.md)
...
5. **结合概率契约监控**：对多租户场景的访问模式进行统计监控，异常访问触发告警（参见 [`../05-probabilistic-contracts/probabilistic-contract-framework.md`](12-ai-native-reuse/05-probabilistic-contracts/probabilistic-contract-framework.md)）。
...
- MCP 协议规范见 [`../01-mcp-protocol/mcp-2025-11-25-authoritative.md`](12-ai-native-reuse/01-mcp-protocol/mcp-2025-11-25-authoritative.md)
- Agent 组合模式见 [`../03-agentic-infrastructure/llm-agent-composition.md`](12-ai-native-reuse/03-agentic-infrastructure/llm-agent-composition.md)
- 概率契约与 SLA 见 [`../05-probabilistic-contracts/probabilistic-contract-framework.md`](12-ai-native-reuse/05-probabilistic-contracts/probabilistic-contract-framework.md)
- A2A+MCP 混合 PoC 见 [`../04-hybrid-a2a-mcp-poc/README.md`](12-ai-native-reuse/04-hybrid-a2a-mcp-poc/README.md)
- OWASP LLM 安全映射见 [`../05-probabilistic-contracts/owasp-llm-mcp-security.md`](12-ai-native-reuse/05-probabilistic-contracts/owasp-llm-mcp-security.md)
...
- MCP 协议规范见 [`../01-mcp-protocol/mcp-2025-11-25-authoritative.md`](12-ai-native-reuse/01-mcp-protocol/mcp-2025-11-25-authoritative.md)
- A2A 协议规范见 [`../02-a2a-protocol/a2a-v1-authoritative.md`](12-ai-native-reuse/02-a2a-protocol/a2a-v1-authoritative.md)
- 概率契约框架见 [`../05-probabilistic-contracts/probabilistic-contract-framework.md`](12-ai-native-reuse/05-probabilistic-contracts/probabilistic-contract-framework.md)
- Conformal Prediction 见 [`../07-conformal-prediction/cp-formal-verification.md`](12-ai-native-reuse/07-conformal-prediction/cp-formal-verification.md)
- A2A+MCP 混合 PoC 见 [`../04-hybrid-a2a-mcp-poc/README.md`](12-ai-native-reuse/04-hybrid-a2a-mcp-poc/README.md)
- OWASP LLM 安全映射见 [`../05-probabilistic-contracts/owasp-llm-mcp-security.md`](12-ai-native-reuse/05-probabilistic-contracts/owasp-llm-mcp-security.md)
...
- Conformal Prediction 与形式化验证的交叉见 [`../07-conformal-prediction/cp-formal-verification.md`](12-ai-native-reuse/07-conformal-prediction/cp-formal-verification.md)
- MCP 协议规范见 [`../01-mcp-protocol/mcp-2025-11-25-authoritative.md`](12-ai-native-reuse/01-mcp-protocol/mcp-2025-11-25-authoritative.md)
- A2A 协议规范见 [`../02-a2a-protocol/a2a-v1-authoritative.md`](12-ai-native-reuse/02-a2a-protocol/a2a-v1-authoritative.md)
- Agent 组合与不确定性组合见 [`../03-agentic-infrastructure/llm-agent-composition.md`](12-ai-native-reuse/03-agentic-infrastructure/llm-agent-composition.md)
- 监控指标与运行时验证见 [`./monitoring-metrics.md`](12-ai-native-reuse/05-probabilistic-contracts/monitoring-metrics.md)
- OWASP LLM 安全映射见 [`./owasp-llm-mcp-security.md`](12-ai-native-reuse/05-probabilistic-contracts/owasp-llm-mcp-security.md)
- AI SLA 模板见 [`./templates/ai-sla-template.md`](12-ai-native-reuse/05-probabilistic-contracts/templates/ai-sla-template.md)
- 校准报告模板见 [`./templates/calibration-report-template.md`](12-ai-native-reuse/05-probabilistic-contracts/templates/calibration-report-template.md)
...
- MCP 协议规范见 [`../01-mcp-protocol/mcp-2025-11-25-authoritative.md`](12-ai-native-reuse/01-mcp-protocol/mcp-2025-11-25-authoritative.md)
- A2A 协议规范见 [`../02-a2a-protocol/a2a-v1-authoritative.md`](12-ai-native-reuse/02-a2a-protocol/a2a-v1-authoritative.md)
- Agent 组合与不确定性见 [`../03-agentic-infrastructure/llm-agent-composition.md`](12-ai-native-reuse/03-agentic-infrastructure/llm-agent-composition.md)
- 监控指标见 [`../05-probabilistic-contracts/monitoring-metrics.md`](12-ai-native-reuse/05-probabilistic-contracts/monitoring-metrics.md)
