...
> **定位**: 提供 MCP 当前稳定版 2025-11-25 的权威技术解析；2026-07-28 为官方 RC（2026-05-29 发布，最终版预计 2026-07-28），生产基线以稳定版为准
...
`2026-07-28` 是官方 Release Candidate（RC，2026-05-29 发布），最终版预计 2026-07-28；截至 2026-07-11 最终版尚未发布，生产环境仍以 **MCP 2025-11-25** 为稳定基线。项目中涉及生产/稳定基线的引用应以 **MCP 2025-11-25** 为准；引用 2026-07-28 时必须明确标注 RC（前瞻特性，非稳定版）。
...
以下文件/位置涉及生产基线，应以 "MCP 2025-11-25" 为稳定版引用（如确需引用 2026-07-28，必须标注 RC）：
...
- [NIST AI 风险管理框架与架构复用映射](#nist-ai-风险管理框架与架构复用映射)
  ...
  - [正向示例：MCP 工具目录的 AI RMF 治理](#正向示例mcp-工具目录的-ai-rmf-治理)
  - [反例：未评估即复用开源 Agent 导致合规事故](#反例未评估即复用开源-agent-导致合规事故)
  - [交叉引用](#交叉引用)
  - [分析与讨论](#分析与讨论)
  - [8. 权威来源](#8-权威来源)
